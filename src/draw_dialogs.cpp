...
void CGame::DrawDialogBox_15AgeMsg(short msX, short msY)
{
    ...
    PutString(sX + 30, sY + 26, "2003³â 1¿ù 16ÀÏ ÀÌÈÄºÎÅÍ´Â '¿µ»ó¹° ½ÉÀÇ µî±Þ", Color(200, 200, 45));
    PutString(sX + 30, sY + 43, "À§¿øÈ¸'ÀÇ ½ÉÀÇ ÆÇÁ¤¿¡ µû¶ó ¸¸ 15¼¼ ¹Ì¸¸ÀÇ", Color(200, 200, 45));
    PutString(sX + 30, sY + 60, "ÇÃ·¹ÀÌ¾î´Â °ÔÀÓ¿¡ Á¢¼ÓÇÒ ¼ö ¾ø½À´Ï´Ù. ¹®ÀÇ»çÇ×", Color(200, 200, 45));
    PutString(sX + 30, sY + 78, "Àº Çïºê·¹½º È¨ÆäÀÌÁö(http://www.helbreath", Color(200, 200, 45));
    PutString(sX + 30, sY + 96, ".com) Á¢¼ÓÇÏ½Ã°Å³ª Çïºê·¹½º °í°´Áö¿øÆÀÀ¸·Î", Color(200, 200, 45));
    PutString(sX + 30, sY + 114, "¿¬¶ôÇØ ÁÖ½Ã±â ¹Ù¶ø´Ï´Ù.", Color(200, 200, 45));
...
#if DEF_LANGUAGE == 5	
    PutString(sX + 59, sY + 57, DEF_MSG_WARNING2, Color(220, 130, 45));
    PutString(sX + 59, sY + 74, DEF_MSG_WARNING3, Color(220, 130, 45));
    PutString(sX + 59, sY + 92, DEF_MSG_WARNING4, Color(220, 130, 45));
    PutString(sX + 59, sY + 110, DEF_MSG_WARNING5, Color(220, 130, 45));

#else
    PutString(sX + 30, sY + 57, DEF_MSG_WARNING2, Color(220, 130, 45));
    PutString(sX + 30, sY + 74, DEF_MSG_WARNING3, Color(220, 130, 45));
    PutString(sX + 30, sY + 92, DEF_MSG_WARNING4, Color(220, 130, 45));
    PutString(sX + 30, sY + 110, DEF_MSG_WARNING5, Color(220, 130, 45));
#endif
...
void CGame::DrawDialogBox_NpcTalk(short msX, short msY, char cLB)
{
    ...
    for (i = 0; i < 17; i++)
        ...
        {
            PutAlignedString(sX, sX + m_stDialogBoxInfo[21].sSizeX, sY + 57 + i * 15, m_pMsgTextList2[i + m_stDialogBoxInfo[21].sView]->message, 45, 25, 25);
        }
...
void CGame::DrawDialogBox_Chat(short msX, short msY, short msZ, char cLB)
{
    ...
    for (i = 0; i < 8; i++)
        if (m_pChatScrollList[i + m_stDialogBoxInfo[10].sView] != NULL)
        {
            ...
            {
                case 0:  PutChatWindowString(sX + 25, sY + 127 - i * 13, m_pChatScrollList[i + m_stDialogBoxInfo[10].sView]->message, Color(230, 230, 230)); break;
                case 1:  PutChatWindowString(sX + 25, sY + 127 - i * 13, m_pChatScrollList[i + m_stDialogBoxInfo[10].sView]->message, Color(130, 200, 130)); break;
                case 2:  PutChatWindowString(sX + 25, sY + 127 - i * 13, m_pChatScrollList[i + m_stDialogBoxInfo[10].sView]->message, Color(255, 130, 130)); break;
                case 3:  PutChatWindowString(sX + 25, sY + 127 - i * 13, m_pChatScrollList[i + m_stDialogBoxInfo[10].sView]->message, Color(130, 130, 255)); break;
                case 4:  PutChatWindowString(sX + 25, sY + 127 - i * 13, m_pChatScrollList[i + m_stDialogBoxInfo[10].sView]->message, Color(230, 230, 130)); break;
                case 10: PutChatWindowString(sX + 25, sY + 127 - i * 13, m_pChatScrollList[i + m_stDialogBoxInfo[10].sView]->message, Color(180, 255, 180)); break;
                case 20: PutChatWindowString(sX + 25, sY + 127 - i * 13, m_pChatScrollList[i + m_stDialogBoxInfo[10].sView]->message, Color(150, 150, 170)); break;
            }
        }
                ...
                if (m_bIsItemDisabled[m_cItemOrder[i]] == TRUE)
                {
                    ...
                    else
                    {
                            ...
                            (m_pItemList[m_cItemOrder[i]]->m_cEquipPos == DEF_EQUIPPOS_TWOHAND))
                        {
                            ...
                            m_pSprite[DEF_SPRID_ITEMPACK_PIVOTPOINT + m_pItemList[m_cItemOrder[i]]->m_sSprite]->PutTransSpriteColor(sX + 32 + m_pItemList[m_cItemOrder[i]]->m_sX,
                ...
                else
                {
                    ...
                    else
                    {
                            ...
                            (m_pItemList[m_cItemOrder[i]]->m_cEquipPos == DEF_EQUIPPOS_TWOHAND))
                        {
                            ...
                            m_pSprite[DEF_SPRID_ITEMPACK_PIVOTPOINT + m_pItemList[m_cItemOrder[i]]->m_sSprite]->PutSpriteColor(sX + 32 + m_pItemList[m_cItemOrder[i]]->m_sX,
                                sY + 44 + m_pItemList[m_cItemOrder[i]]->m_sY, m_pItemList[m_cItemOrder[i]]->m_sSpriteFrame,
                                m_wWR[cItemColor] - m_wR[0], m_wWG[cItemColor] - m_wG[0], m_wWB[cItemColor] - m_wB[0],
                                dwTime);
                        }
                    ...
                    if ((msX > sX + 30) && (msX < sX + 210) && (msY >= sY + 110 + i * 15) && (msY <= sY + 124 + i * 15))
                    {
                        ...
                        else
                        {
                                ...
                                (m_pBankList[i + m_stDialogBoxInfo[14].sView]->m_cEquipPos == DEF_EQUIPPOS_TWOHAND))
                            {
                                ...
                                m_pSprite[DEF_SPRID_ITEMPACK_PIVOTPOINT + m_pBankList[i + m_stDialogBoxInfo[14].sView]->m_sSprite]->PutSpriteColor(sX + 60, sY + 68, m_pBankList[i + m_stDialogBoxInfo[14].sView]->m_sSpriteFrame,
                                    m_wWR[cItemColor] - m_wR[0], m_wWG[cItemColor] - m_wG[0], m_wWB[cItemColor] - m_wB[0], m_dwCurTime);
                            }
                            else m_pSprite[DEF_SPRID_ITEMPACK_PIVOTPOINT + m_pBankList[i + m_stDialogBoxInfo[14].sView]->m_sSprite]->PutSpriteColor(sX + 60, sY + 68, m_pBankList[i + m_stDialogBoxInfo[14].sView]->m_sSpriteFrame,
                                m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
                        }
                    }
                    else
...
void CGame::DrawDialogBox_Character(short msX, short msY)
{
    ...
    if ((m_sPlayerType >= 1) && (m_sPlayerType <= 3))
    {
        ...
        if (cEquipPosStatus[DEF_EQUIPPOS_HEAD] == -1)
        {
            ...
            m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + 18]->PutSpriteColor(sX + 171, sY + 290, (m_sPlayerAppr1 & 0x0F00) >> 8, iR, iG, iB, m_dwCurTime);
        }
        ...
        if (cEquipPosStatus[DEF_EQUIPPOS_BACK] != -1)
        {
            ...
            if (m_bIsItemDisabled[cEquipPosStatus[DEF_EQUIPPOS_BACK]] == FALSE)
            {
                ...
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutSpriteColor(sX + 41, sY + 137, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
            else
            {
                if (cItemColor == 0)
                    m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutTransSprite2(sX + 41, sY + 137, sFrame, m_dwCurTime);
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutTransSpriteColor(sX + 41, sY + 137, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
        ...
        if (cEquipPosStatus[DEF_EQUIPPOS_PANTS] != -1)
        {
            ...
            if (m_bIsItemDisabled[cEquipPosStatus[DEF_EQUIPPOS_PANTS]] == FALSE)
            {
                ...
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutSpriteColor(sX + 171, sY + 290, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
            else
            {
                if (cItemColor == 0)
                    m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutTransSprite2(sX + 171, sY + 290, sFrame, m_dwCurTime);
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutTransSpriteColor(sX + 171, sY + 290, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
        ...
        if (cEquipPosStatus[DEF_EQUIPPOS_LHAND] != -1)
        {
            ...
            if (m_bIsItemDisabled[cEquipPosStatus[DEF_EQUIPPOS_LHAND]] == FALSE)
            {
                ...
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutSpriteColor(sX + 90, sY + 170, sFrame, m_wWR[cItemColor] - m_wR[0], m_wWG[cItemColor] - m_wG[0], m_wWB[cItemColor] - m_wB[0], m_dwCurTime);
            }
            else
            {
                if (cItemColor == 0)
                    m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutTransSprite2(sX + 90, sY + 170, sFrame, m_dwCurTime);
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutTransSpriteColor(sX + 90, sY + 170, sFrame, m_wWR[cItemColor] - m_wR[0], m_wWG[cItemColor] - m_wG[0], m_wWB[cItemColor] - m_wB[0], m_dwCurTime);
            }
        ...
        if (cEquipPosStatus[DEF_EQUIPPOS_RHAND] != -1)
        {
            ...
            if (m_bIsItemDisabled[cEquipPosStatus[DEF_EQUIPPOS_RHAND]] == FALSE)
            {
                ...
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutSpriteColor(sX + 57, sY + 186, sFrame, m_wWR[cItemColor] - m_wR[0], m_wWG[cItemColor] - m_wG[0], m_wWB[cItemColor] - m_wB[0], m_dwCurTime);
            }
            else
            {
                if (cItemColor == 0)
                    m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutTransSprite2(sX + 57, sY + 186, sFrame, m_dwCurTime);
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutTransSpriteColor(sX + 57, sY + 186, sFrame, m_wWR[cItemColor] - m_wR[0], m_wWG[cItemColor] - m_wG[0], m_wWB[cItemColor] - m_wB[0], m_dwCurTime);
            }
        ...
        if (cEquipPosStatus[DEF_EQUIPPOS_NECK] != -1)
        {
            ...
            if (m_bIsItemDisabled[cEquipPosStatus[DEF_EQUIPPOS_NECK]] == FALSE)
            {
                ...
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutSpriteColor(sX + 35, sY + 120, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
            else
            {
                if (cItemColor == 0)
                    m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutTransSprite2(sX + 35, sY + 120, sFrame, m_dwCurTime);
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutTransSpriteColor(sX + 35, sY + 120, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
        ...
        if (cEquipPosStatus[DEF_EQUIPPOS_RFINGER] != -1)
        {
            ...
            if (m_bIsItemDisabled[cEquipPosStatus[DEF_EQUIPPOS_RFINGER]] == FALSE)
            {
                ...
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutSpriteColor(sX + 32, sY + 193, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
            else
            {
                if (cItemColor == 0)
                    m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutTransSprite2(sX + 32, sY + 193, sFrame, m_dwCurTime);
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutTransSpriteColor(sX + 32, sY + 193, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
        ...
        if (cEquipPosStatus[DEF_EQUIPPOS_HEAD] != -1)
        {
            ...
            if (m_bIsItemDisabled[cEquipPosStatus[DEF_EQUIPPOS_HEAD]] == FALSE)
            {
                ...
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutSpriteColor(sX + 72, sY + 135, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
            else
            {
                if (cItemColor == 0)
                    m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutTransSprite2(sX + 72, sY + 135, sFrame, m_dwCurTime);
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH]->PutTransSpriteColor(sX + 72, sY + 135, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
    ...
    else if ((m_sPlayerType >= 4) && (m_sPlayerType <= 6))
    {
        ...
        {
            _GetHairColorColor(((m_sPlayerAppr1 & 0x00F0) >> 4), &iR, &iG, &iB);
            m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + 18 + 40]->PutSpriteColor(sX + 171, sY + 290, (m_sPlayerAppr1 & 0x0F00) >> 8, iR, iG, iB, m_dwCurTime);
        }
        ...
        if (cEquipPosStatus[DEF_EQUIPPOS_BACK] != -1)
        {
            ...
            if (m_bIsItemDisabled[cEquipPosStatus[DEF_EQUIPPOS_BACK]] == FALSE)
            {
                ...
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutSpriteColor(sX + 45, sY + 143, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
            else
            {
                if (cItemColor == 0)
                    m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutTransSprite2(sX + 45, sY + 143, sFrame, m_dwCurTime);
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutTransSpriteColor(sX + 45, sY + 143, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
        ...
        if ((cEquipPosStatus[DEF_EQUIPPOS_BOOTS] != -1) && (iSkirtDraw == 1))
        {
            ...
            if (m_bIsItemDisabled[cEquipPosStatus[DEF_EQUIPPOS_BOOTS]] == FALSE)
            {
                ...
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutSpriteColor(sX + 171, sY + 290, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
            else
            {
                if (cItemColor == 0)
                    m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutTransSprite2(sX + 171, sY + 290, sFrame, m_dwCurTime);
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutTransSpriteColor(sX + 171, sY + 290, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
        ...
        if (cEquipPosStatus[DEF_EQUIPPOS_LHAND] != -1)
        {
            ...
            if (m_bIsItemDisabled[cEquipPosStatus[DEF_EQUIPPOS_LHAND]] == FALSE)
            {
                ...
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutSpriteColor(sX + 84, sY + 175, sFrame, m_wWR[cItemColor] - m_wR[0], m_wWG[cItemColor] - m_wG[0], m_wWB[cItemColor] - m_wB[0], m_dwCurTime);
            }
            else
            {
                if (cItemColor == 0)
                    m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutTransSprite2(sX + 84, sY + 175, sFrame, m_dwCurTime);
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutTransSpriteColor(sX + 84, sY + 175, sFrame, m_wWR[cItemColor] - m_wR[0], m_wWG[cItemColor] - m_wG[0], m_wWB[cItemColor] - m_wB[0], m_dwCurTime);
            }
        ...
        if (cEquipPosStatus[DEF_EQUIPPOS_RHAND] != -1)
        {
            ...
            if (m_bIsItemDisabled[cEquipPosStatus[DEF_EQUIPPOS_RHAND]] == FALSE)
            {
                ...
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutSpriteColor(sX + 60, sY + 191, sFrame, m_wWR[cItemColor] - m_wR[0], m_wWG[cItemColor] - m_wG[0], m_wWB[cItemColor] - m_wB[0], m_dwCurTime);
            }
            else
            {
                if (cItemColor == 0)
                    m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutTransSprite2(sX + 60, sY + 191, sFrame, m_dwCurTime);
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutTransSpriteColor(sX + 60, sY + 191, sFrame, m_wWR[cItemColor] - m_wR[0], m_wWG[cItemColor] - m_wG[0], m_wWB[cItemColor] - m_wB[0], m_dwCurTime);
            }
        ...
        if (cEquipPosStatus[DEF_EQUIPPOS_NECK] != -1)
        {
            ...
            if (m_bIsItemDisabled[cEquipPosStatus[DEF_EQUIPPOS_NECK]] == FALSE)
            {
                ...
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutSpriteColor(sX + 35, sY + 120, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
            else
            {
                if (cItemColor == 0)
                    m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutTransSprite2(sX + 35, sY + 120, sFrame, m_dwCurTime);
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutTransSpriteColor(sX + 35, sY + 120, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
        ...
        if (cEquipPosStatus[DEF_EQUIPPOS_RFINGER] != -1)
        {
            ...
            if (m_bIsItemDisabled[cEquipPosStatus[DEF_EQUIPPOS_RFINGER]] == FALSE)
            {
                ...
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutSpriteColor(sX + 32, sY + 193, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
            else
            {
                if (cItemColor == 0)
                    m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutTransSprite2(sX + 32, sY + 193, sFrame, m_dwCurTime);
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutTransSpriteColor(sX + 32, sY + 193, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
        ...
        if (cEquipPosStatus[DEF_EQUIPPOS_HEAD] != -1)
        {
            ...
            if (m_bIsItemDisabled[cEquipPosStatus[DEF_EQUIPPOS_HEAD]] == FALSE)
            {
                ...
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutSpriteColor(sX + 72, sY + 139, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
            else
            {
                if (cItemColor == 0)
                    m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutTransSprite2(sX + 72, sY + 139, sFrame, m_dwCurTime);
                else m_pSprite[DEF_SPRID_ITEMEQUIP_PIVOTPOINT + sSprH + 40]->PutTransSpriteColor(sX + 72, sY + 139, sFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], m_dwCurTime);
            }
...
void CGame::DrawDialogBox_LevelUpSetting(short msX, short msY)
{
    ...
    PutString(sX + 20, sY + 80, cTxt, Color(0, 0, 0));

    format_to_local(cTxt, DRAW_DIALOGBOX_LEVELUP_SETTING3, m_iLU_Point);
    PutString(sX + 40,  sY + 85, cTxt, Color(0,0,0));
    
    format_to_local(cTxt, "{}", m_iLU_Point);
    PutString(sX + 105, sY + 103, cTxt, Color(0, 0, 0));

    PutString(sX + 20, sY + 127, DRAW_DIALOGBOX_LEVELUP_SETTING4, Color(5, 5, 5));//"Strength"
    format_to_local(cTxt, "{}", m_cLU_Str);
    PutString(sX + 158, sY + 127, cTxt, Color(25, 35, 25));
    format_to_local(cTxt, "{}", m_iStr);
    PutString(sX + 105, sY + 127, cTxt, Color(25, 35, 25));

    PutString(sX + 20, sY + 147, DRAW_DIALOGBOX_LEVELUP_SETTING5, Color(5, 5, 5));//"Vitality"
    format_to_local(cTxt, "{}", m_cLU_Vit);
    PutString(sX + 158, sY + 147, cTxt, Color(25, 35, 25));
    format_to_local(cTxt, "{}", m_iVit);
    PutString(sX + 105, sY + 147, cTxt, Color(25, 35, 25));

    PutString(sX + 20, sY + 165, DRAW_DIALOGBOX_LEVELUP_SETTING6, Color(5, 5, 5));//"Dexterity"
    format_to_local(cTxt, "{}", m_cLU_Dex);
    PutString(sX + 158, sY + 165, cTxt, Color(25, 35, 25));
    format_to_local(cTxt, "{}", m_iDex);
    PutString(sX + 105, sY + 165, cTxt, Color(25, 35, 25));

    PutString(sX + 20, sY + 185, DRAW_DIALOGBOX_LEVELUP_SETTING7, Color(5, 5, 5));//"Intelligence"
    format_to_local(cTxt, "{}", m_cLU_Int);
    PutString(sX + 158, sY + 185, cTxt, Color(25, 35, 25));
    format_to_local(cTxt, "{}", m_iInt);
    PutString(sX + 105, sY + 185, cTxt, Color(25, 35, 25));

    PutString(sX + 20, sY + 203, DRAW_DIALOGBOX_LEVELUP_SETTING8, Color(5, 5, 5));//"Magic"
    format_to_local(cTxt, "{}", m_cLU_Mag);
    PutString(sX + 158, sY + 203, cTxt, Color(25, 35, 25));
    format_to_local(cTxt, "{}", m_iMag);
    PutString(sX + 105, sY + 203, cTxt, Color(25, 35, 25));

    PutString(sX + 20, sY + 223, DRAW_DIALOGBOX_LEVELUP_SETTING9, Color(5, 5, 5));//"Charisma"
    format_to_local(cTxt, "{}", m_cLU_Char);
    PutString(sX + 158, sY + 223, cTxt, Color(25, 35, 25));
    format_to_local(cTxt, "{}", m_iCharisma);
    PutString(sX + 105, sY + 223, cTxt, Color(25, 35, 25));
    ...
    {
        case 0:	break;
        case 1: PutAlignedString(sX, sX + szX, sY + 295, DRAW_DIALOGBOX_LEVELUP_SETTING14, 65, 0, 0);
            break;
        case 2: PutAlignedString(sX, sX + szX, sY + 295, DRAW_DIALOGBOX_LEVELUP_SETTING15, 65, 0, 0);
            PutAlignedString(sX, sX + szX, sY + 310, DRAW_DIALOGBOX_LEVELUP_SETTING16, 65, 0, 0);
            PutAlignedString(sX, sX + szX, sY + 325, DRAW_DIALOGBOX_LEVELUP_SETTING17, 65, 0, 0);
            break;
    }
}
...
void CGame::DrawDialogBox_LevelUpSetting(short msX, short msY)
{
    ...
    PutString(sX + 44, sY + 110, DRAW_DIALOGBOX_LEVELUP_SETTING4, Color(5, 5, 5));//"Strength"
    PutString(sX + 139, sY + 112, "_____", Color(5, 5, 5));
    format_to_local(cTxt, "{}", m_cLU_Str);
    PutString(sX + 139, sY + 110, cTxt, Color(25, 35, 25));
    ...
    PutString(sX + 44, sY + 125, DRAW_DIALOGBOX_LEVELUP_SETTING5, Color(5, 5, 5));//"Vitality"
    PutString(sX + 139, sY + 127, "_____", Color(5, 5, 5));
    format_to_local(cTxt, "{}", m_cLU_Vit);
    PutString(sX + 139, sY + 125, cTxt, Color(25, 35, 25));
    ...
    PutString(sX + 44, sY + 140, DRAW_DIALOGBOX_LEVELUP_SETTING6, Color(5, 5, 5));//"Dexterity"
    PutString(sX + 139, sY + 142, "_____", Color(5, 5, 5));
    format_to_local(cTxt, "{}", m_cLU_Dex);
    PutString(sX + 139, sY + 140, cTxt, Color(25, 35, 25));
    ...
    PutString(sX + 44, sY + 155, DRAW_DIALOGBOX_LEVELUP_SETTING7, Color(5, 5, 5));//"Intelligence"
    PutString(sX + 139, sY + 157, "_____", Color(5, 5, 5));
    format_to_local(cTxt, "{}", m_cLU_Int);
    PutString(sX + 139, sY + 155, cTxt, Color(25, 35, 25));
    ...
    PutString(sX + 44, sY + 170, DRAW_DIALOGBOX_LEVELUP_SETTING8, Color(5, 5, 5));//"Magic"
    PutString(sX + 139, sY + 172, "_____", Color(5, 5, 5));
    format_to_local(cTxt, "{}", m_cLU_Mag);
    PutString(sX + 139, sY + 170, cTxt, Color(25, 35, 25));
    ...
    PutString(sX + 44, sY + 185, DRAW_DIALOGBOX_LEVELUP_SETTING9, Color(5, 5, 5));//"Charisma"
    PutString(sX + 139, sY + 187, "_____", Color(5, 5, 5));
    format_to_local(cTxt, "{}", m_cLU_Char);
    PutString(sX + 139, sY + 185, cTxt, Color(25, 35, 25));
    ...
    PutAlignedString(sX, sX + szX, sY + 220, DRAW_DIALOGBOX_LEVELUP_SETTING10);
    PutAlignedString(sX, sX + szX, sY + 235, DRAW_DIALOGBOX_LEVELUP_SETTING11);
    PutAlignedString(sX, sX + szX, sY + 250, DRAW_DIALOGBOX_LEVELUP_SETTING12);
    PutAlignedString(sX, sX + szX, sY + 265, DRAW_DIALOGBOX_LEVELUP_SETTING13);
...
void CGame::DrawDialogBox_CityHallMenu(short msX, short msY)
{
    ...
    switch (m_stDialogBoxInfo[13].cMode)
    {
        case 0:
            ...
            if ((m_bIsCrusadeMode == FALSE) && m_bCitizen && (m_iPKCount == 0))
            {
                if ((msX > sX + 35) && (msX < sX + 220) && (msY > sY + 195) && (msY < sY + 220))
                    PutAlignedString(sX, sX + szX, sY + 195, DRAW_DIALOGBOX_CITYHALL_MENU69, 255, 255, 255);
            ...
            if (m_bIsCrusadeMode && m_bCitizen)
            {
                if ((msX > sX + 35) && (msX < sX + 220) && (msY > sY + 220) && (msY < sY + 220))
                    PutAlignedString(sX, sX + szX, sY + 220, DRAW_DIALOGBOX_CITYHALL_MENU14, 255, 255, 255);
            ...
            PutAlignedString(sX, sX + szX, sY + 245, DRAW_DIALOGBOX_CITYHALL_MENU17);
        ...
        case 7:
            PutAlignedString(sX, sX + szX, sY + 80, DRAW_DIALOGBOX_CITYHALL_MENU46, 55, 25, 25);
            PutAlignedString(sX, sX + szX, sY + 95, DRAW_DIALOGBOX_CITYHALL_MENU47, 55, 25, 25);
            PutAlignedString(sX, sX + szX, sY + 110, DRAW_DIALOGBOX_CITYHALL_MENU48, 55, 25, 25);
            PutAlignedString(sX, sX + szX, sY + 125, DRAW_DIALOGBOX_CITYHALL_MENU49, 55, 25, 25);
            PutAlignedString(sX, sX + szX, sY + 140, DRAW_DIALOGBOX_CITYHALL_MENU50, 55, 25, 25);
            PutAlignedString(sX, sX + szX, sY + 155, DRAW_DIALOGBOX_CITYHALL_MENU51, 55, 25, 25);
            PutAlignedString(sX, sX + szX, sY + 170, DRAW_DIALOGBOX_CITYHALL_MENU52, 55, 25, 25);

            PutAlignedString(sX, sX + szX, sY + 205, DRAW_DIALOGBOX_CITYHALL_MENU53, 55, 25, 25);
        ...
        case 10:
            ...
            {
                PutAlignedString(sX, sX + szX, sY + 50, DRAW_DIALOGBOX_CITYHALL_MENU69, 55, 25, 25);
                PutAlignedString(sX, sX + szX, sY + 80, DRAW_DIALOGBOX_CITYHALL_MENU70, 55, 25, 25);
                ...
                PutString2(sX + 21, sY + 200, DRAW_DIALOGBOX_CITYHALL_MENU72_1, 55, 25, 25);
...
void CGame::DrawDialogBox_Exchange(short msX, short msY)
{
    ...
    switch (m_stDialogBoxInfo[27].cMode)
    {
        case 1:
            if (m_stDialogBoxInfo[27].sV1 != -1)
            {
                ...
                else
                {
                    switch (m_stDialogBoxInfo[27].sV1)
                    {
                        case 1:
                        case 2:
                        case 3:  m_pSprite[DEF_SPRID_ITEMPACK_PIVOTPOINT + m_stDialogBoxInfo[27].sV1]->PutSpriteColor(sX + 130, sY + 100, m_stDialogBoxInfo[27].sV2,
                            m_wWR[cItemColor] - m_wR[0], m_wWG[cItemColor] - m_wG[0], m_wWB[cItemColor] - m_wB[0], dwTime); break;

                        default: m_pSprite[DEF_SPRID_ITEMPACK_PIVOTPOINT + m_stDialogBoxInfo[27].sV1]->PutSpriteColor(sX + 130, sY + 100, m_stDialogBoxInfo[27].sV2,
            ...
            if (m_stDialogBoxInfo[27].sV5 != -1)
            {
                ...
                else
                {
                    switch (m_stDialogBoxInfo[27].sV5)
                    {
                        case 1:
                        case 2:
                        case 3:  m_pSprite[DEF_SPRID_ITEMPACK_PIVOTPOINT + m_stDialogBoxInfo[27].sV5]->PutSpriteColor(sX + 400, sY + 100, m_stDialogBoxInfo[27].sV6,
                            m_wWR[cItemColor] - m_wR[0], m_wWG[cItemColor] - m_wG[0], m_wWB[cItemColor] - m_wB[0], dwTime); break;

                        default: m_pSprite[DEF_SPRID_ITEMPACK_PIVOTPOINT + m_stDialogBoxInfo[27].sV5]->PutSpriteColor(sX + 400, sY + 100, m_stDialogBoxInfo[27].sV6,
                            m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], dwTime); break;
                    }
                }
            ...
            {
                PutAlignedString(sX, sX + szX, sY + 235 + 10, DRAW_DIALOGBOX_EXCHANGE9, 55, 25, 25);
                PutAlignedString(sX, sX + szX, sY + 250 + 10, DRAW_DIALOGBOX_EXCHANGE10, 55, 25, 25);
                PutAlignedString(sX, sX + szX, sY + 265 + 10, DRAW_DIALOGBOX_EXCHANGE11, 55, 25, 25);
            }
            else if ((m_stDialogBoxInfo[27].sV1 == -1) && (m_stDialogBoxInfo[27].sV5 != -1))
            {
                PutAlignedString(sX, sX + szX, sY + 205 + 10, DRAW_DIALOGBOX_EXCHANGE12, 55, 25, 25);
                PutAlignedString(sX, sX + szX, sY + 220 + 10, DRAW_DIALOGBOX_EXCHANGE13, 55, 25, 25);
                PutAlignedString(sX, sX + szX, sY + 235 + 10, DRAW_DIALOGBOX_EXCHANGE14, 55, 25, 25);
                PutAlignedString(sX, sX + szX, sY + 250 + 10, DRAW_DIALOGBOX_EXCHANGE15, 55, 25, 25);
                PutAlignedString(sX, sX + szX, sY + 265 + 10, DRAW_DIALOGBOX_EXCHANGE16, 55, 25, 25);
                PutAlignedString(sX, sX + szX, sY + 280 + 10, DRAW_DIALOGBOX_EXCHANGE17, 55, 25, 25);
            }
            else if ((m_stDialogBoxInfo[27].sV1 != -1) && (m_stDialogBoxInfo[27].sV5 != -1))
            {
                PutAlignedString(sX, sX + szX, sY + 205 + 10, DRAW_DIALOGBOX_EXCHANGE18, 55, 25, 25);
                PutAlignedString(sX, sX + szX, sY + 220 + 10, DRAW_DIALOGBOX_EXCHANGE19, 55, 25, 25);
                PutAlignedString(sX, sX + szX, sY + 235 + 10, DRAW_DIALOGBOX_EXCHANGE20, 55, 25, 25);
                PutAlignedString(sX, sX + szX, sY + 250 + 10, DRAW_DIALOGBOX_EXCHANGE21, 55, 25, 25);
                PutAlignedString(sX, sX + szX, sY + 265 + 10, DRAW_DIALOGBOX_EXCHANGE22, 55, 25, 25);
                PutAlignedString(sX, sX + szX, sY + 280 + 10, DRAW_DIALOGBOX_EXCHANGE23, 55, 25, 25);
            }
    ...
    switch (m_stDialogBoxInfo[24].cMode)
    {
        case 0:
            ...
            if ((msX >= sX + 160) && (msX <= sX + 253) && (msY >= sY + 70) && (msY <= sY + 90))
                PutString(sX + 160, sY + 70, "²{¦b´N¸Õ¸Õ¡T", Color(78, 64, 249));
            else PutString(sX + 160, sY + 70, "²{¦b´N¸Õ¸Õ¡T", Color(26, 11, 216));
#else
            if ((msX >= sX + 160) && (msX <= sX + 253) && (msY >= sY + 70) && (msY <= sY + 90))
...
void CGame::DrawDialogBox_GuildMenu(short msX, short msY)
{
    ...
    switch (m_stDialogBoxInfo[7].cMode)
    {
        ...
        case 1:
            ...
            PutString(sX + 24, sY + 176, DRAW_DIALOGBOX_GUILDMENU82, Color(55, 25, 25));
            PutString(sX + 24, sY + 192, DRAW_DIALOGBOX_GUILDMENU83, Color(55, 25, 25));
#endif


            if (iGetTopDialogBoxIndex() != 7)
                PutString(sX + 75, sY + 140, m_cGuildName, Color(255, 255, 255));
...
void CGame::DrawDialogBox_GuideMap(short msX, short msY, char cLB)
{
    ...
    {
        PutPixel(sX + shX, sY - 2, 50, 50, 50);
        PutPixel(sX + shX, sY - 1, 50, 50, 50);
        PutPixel(sX + shX, sY + 128, 50, 50, 50);
        PutPixel(sX + shX, sY + 129, 50, 50, 50);
    }
    for (shY = -2; shY < 130; shY++)
    {
        PutPixel(sX - 2, sY + shY, 50, 50, 50);
        PutPixel(sX - 1, sY + shY, 50, 50, 50);
        PutPixel(sX + 128, sY + shY, 50, 50, 50);
        PutPixel(sX + 129, sY + shY, 50, 50, 50);
    }
    if (m_bZoomMap)
    {
        shX = m_sPlayerX - 64;
    ...
    if (msX >= sX && msX < sX + szY && msY >= sY && msY < sY + szY)
    {
        ...
        PutString(msX - 10, msY - 13, output, Color(200, 200, 120));
    }
}
...
void CGame::DrawDialogBox_IconPannel(short msX, short msY)
{
    ...
    if ((msY > 436) && (msY < 478))
    {
        if ((msX > 410) && (msX < 447))
        {
            ...
            if (m_iLevel < 80) PutAlignedString(360, 497, 410, "Ä³¸¯ÅÍ ÀÎÆ÷(F5)", 200, 200, 120);
#endif
        ...
        {
#if DEF_LANGUAGE == 3		// Korea 2.19
            if (m_iLevel < 80) PutAlignedString(397, 534, 410, "ÀÎº¥Åä¸®(F6)", 200, 200, 120);
#endif
        ...
        {
#if DEF_LANGUAGE == 3		// Korea 2.19
            if (m_iLevel < 80) PutAlignedString(434, 571, 410, "¸¶¹ý¸®½ºÆ®(F7)", 200, 200, 120);
#endif
        ...
        {
#if DEF_LANGUAGE == 3		// Korea 2.19
            if (m_iLevel < 80) PutAlignedString(471, 608, 410, "½ºÅ³Á¤º¸(F8)", 200, 200, 120);
#endif
        ...
        {
#if DEF_LANGUAGE == 3		// Korea 2.19
            if (m_iLevel < 80) PutAlignedString(508, 645, 410, "Ã¤ÆÃÈ÷½ºÅä¸®(F9)", 200, 200, 120);
#endif
        ...
        {
#if DEF_LANGUAGE == 3		// Korea 2.19
            if (m_iLevel < 80) PutAlignedString(530, 640, 410, "½Ã½ºÅÛ ¸Þ´º(F12)", 200, 200, 120);
#endif
    ...
    PutAlignedString(140, 323, 456, output, 200, 200, 120);
}
    ...
    for (i = 0; i < 17; i++)
        if (m_pMsgTextList[i + m_stDialogBoxInfo[18].sView] != NULL)
        {
            if (m_bDialogTrans == FALSE)
            {
                ...
                {
                    case '_': PutAlignedString(sX + 24, sX + 236, sY + 50 + i * 13, (m_pMsgTextList[i + m_stDialogBoxInfo[18].sView]->message.c_str() + 1), 255, 255, 255); break;
                    case ';': PutAlignedString(sX + 24, sX + 236, sY + 50 + i * 13, (m_pMsgTextList[i + m_stDialogBoxInfo[18].sView]->message.c_str() + 1), 4, 0, 50); break;
                    default: PutAlignedString(sX + 24, sX + 236, sY + 50 + i * 13, m_pMsgTextList[i + m_stDialogBoxInfo[18].sView]->message, 45, 25, 25); break;
                }
            }
            else PutAlignedString(sX + 24, sX + 236, sY + 50 + i * 13, m_pMsgTextList[i + m_stDialogBoxInfo[18].sView]->message, 0, 0, 0);
        }
    ...
    switch (m_stDialogBoxInfo[20].cMode)
    {
        case 0:
            ...
            if (m_stDialogBoxInfo[20].sV3 == 25)
            {
                ...
                {
                    PutString(sX + 28, sY + 55, DRAW_DIALOGBOX_NPCACTION_QUERY13, Color(255, 255, 255));
            ...
            else if (m_stDialogBoxInfo[20].sV3 == 20)
            {
                if ((msX > sX + 25) && (msX < sX + 100) && (msY > sY + 55) && (msY < sY + 70))
                {
                    PutString(sX + 28, sY + 55, DRAW_DIALOGBOX_NPCACTION_QUERY17, Color(255, 255, 255));
            ...
            else
            {
                if ((msX > sX + 25) && (msX < sX + 100) && (msY > sY + 55) && (msY < sY + 70))
                {
                    PutString(sX + 28, sY + 55, DRAW_DIALOGBOX_NPCACTION_QUERY21, Color(255, 255, 255));
        ...
        case 1:
            ...
            if ((msX > sX + 25) && (msX < sX + 100) && (msY > sY + 55) && (msY < sY + 70))
            {
                PutString(sX + 28, sY + 55, DRAW_DIALOGBOX_NPCACTION_QUERY30, Color(255, 255, 255));
            ...
            {
                PutString(sX + 155, sY + 55, DRAW_DIALOGBOX_NPCACTION_QUERY34, Color(255, 255, 255));
        ...
        case 2:
            ...
            if ((msX > sX + 25) && (msX < sX + 100) && (msY > sY + 55) && (msY < sY + 70))
            {
                PutString(sX + 28, sY + 55, DRAW_DIALOGBOX_NPCACTION_QUERY39, Color(255, 255, 255));
            ...
            else
            {
                if ((msX > sX + 125) && (msX < sX + 180) && (msY > sY + 55) && (msY < sY + 70))
                {
                    PutString(sX + 125, sY + 55, DRAW_DIALOGBOX_NPCACTION_QUERY43, Color(255, 255, 255));
        ...
        case 3:
            ...
            if ((msX > sX + 25) && (msX < sX + 100) && (msY > sY + 55) && (msY < sY + 70))
            {
                PutString(sX + 28, sY + 55, DRAW_DIALOGBOX_NPCACTION_QUERY48, Color(255, 255, 255));
        ...
        case 5:
            ...
            {
                PutString(sX + 28 + 75, sY + 55, DRAW_DIALOGBOX_NPCACTION_QUERY39, Color(255, 255, 255));
            ...
            if (m_bIsDialogEnabled[21] == FALSE)
            {
                if ((msX > sX + 155) && (msX < sX + 210) && (msY > sY + 55) && (msY < sY + 70))
                {
                    PutString(sX + 155, sY + 55, DRAW_DIALOGBOX_NPCACTION_QUERY25, Color(255, 255, 255));
...
void CGame::DrawDialogBox_Party(short msX, short msY)
{
    ...
    switch (m_stDialogBoxInfo[32].cMode)
    {
        case 0:
            ...
            if (m_iPartyStatus != 0)
            {
                if ((msX > sX + 80) && (msX < sX + 195) && (msY > sY + 120) && (msY < sY + 145))
                {
                    ...
                    PutAlignedString(sX, sX + szX, sY + 140, DRAW_DIALOGBOX_PARTY8, 255, 255, 255);
                }
                else
                {
                    PutAlignedString(sX, sX + szX, sY + 125, DRAW_DIALOGBOX_PARTY7, 4, 0, 50);
                    PutAlignedString(sX, sX + szX, sY + 140, DRAW_DIALOGBOX_PARTY8, 4, 0, 50);
                }
            }
            else
            {
                PutAlignedString(sX, sX + szX, sY + 125, DRAW_DIALOGBOX_PARTY7, 65, 65, 65);
                PutAlignedString(sX, sX + szX, sY + 140, DRAW_DIALOGBOX_PARTY8, 65, 65, 65);
            }
#else
            if (m_iPartyStatus != 0)
            {
        ...
        case 1: 
            ...
            PutAlignedString(sX, sX + szX, sY + 125, DRAW_DIALOGBOX_PARTY17_1);
            PutAlignedString(sX, sX + szX, sY + 140, DRAW_DIALOGBOX_PARTY18);
            PutAlignedString(sX, sX + szX, sY + 155, DRAW_DIALOGBOX_PARTY19);
            PutAlignedString(sX, sX + szX, sY + 170, DRAW_DIALOGBOX_PARTY20);
#else
            PutAlignedString(sX, sX + szX, sY + 110, DRAW_DIALOGBOX_PARTY17);
        ...
        case 8:
            ...
            PutAlignedString(sX, sX + szX, sY + 185, DRAW_DIALOGBOX_PARTY45_1);
#else
            PutAlignedString(sX, sX + szX, sY + 95, DRAW_DIALOGBOX_PARTY40);
            PutAlignedString(sX, sX + szX, sY + 110, DRAW_DIALOGBOX_PARTY41);
            PutAlignedString(sX, sX + szX, sY + 125, DRAW_DIALOGBOX_PARTY42);
...
void CGame::DrawDialogBox_SellList(short msX, short msY)
{
    ...
    if (iItem == DEF_MAXSELLLIST)
    {
        ...
        PutAlignedString(sX, sX + szX, sY + 55 + 170 + 282 - 117 - 170, DRAW_DIALOGBOX_SELL_LIST10);
#else
        PutAlignedString(sX, sX + szX, sY + 55 + 155 + 282 - 117 - 170, DRAW_DIALOGBOX_SELL_LIST9);
#endif
    }
        ...
        case 1:
            ...
            else
            {
                ...
                switch (m_pItemList[cItemID]->m_sSprite)
                {
                    ...
                    case 2:
                    case 3:
                    case 15: m_pSprite[DEF_SPRID_ITEMPACK_PIVOTPOINT + m_pItemList[cItemID]->m_sSprite]->PutSpriteColor(sX + 62 + 15, sY + 84 + 30, m_pItemList[cItemID]->m_sSpriteFrame,
                        m_wWR[cItemColor] - m_wR[0], m_wWG[cItemColor] - m_wG[0], m_wWB[cItemColor] - m_wB[0], dwTime); break;


                    default: m_pSprite[DEF_SPRID_ITEMPACK_PIVOTPOINT + m_pItemList[cItemID]->m_sSprite]->PutSpriteColor(sX + 62 + 15, sY + 84 + 30, m_pItemList[cItemID]->m_sSpriteFrame,
                        m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], dwTime); break;
                }
            }
...
void CGame::DrawDialogBox_Shop(short msX, short msY, short msZ, char cLB)
{
    ...
    switch (m_stDialogBoxInfo[11].cMode)
    {
        case 0:
            ...
            PutAlignedString(sX + 22, sX + 165, sY + 45, DRAW_DIALOGBOX_SHOP1);
        ...
        default:
            ...
            PutString(sX + 95 + 30 - 35, sY + 78 + 30 - 10, cTemp, Color(40, 10, 10));
            PutString(sX + 96 + 30 - 35, sY + 78 + 30 - 10, cTemp, Color(40, 10, 10));
            strcpy(cTemp, DRAW_DIALOGBOX_SHOP6);
            
            PutString(sX + 95 + 30 - 35, sY + 93 + 30 - 10, cTemp, Color(40, 10, 10));
            PutString(sX + 96 + 30 - 35, sY + 93 + 30 - 10, cTemp, Color(40, 10, 10));
            ...
            switch (m_pItemForSaleList[m_stDialogBoxInfo[11].cMode - 1]->m_cEquipPos)
            {
                ...
                case DEF_EQUIPPOS_TWOHAND:
                    ...
                    PutString(sX + 40, sY + 145, cTemp, Color(45, 25, 25));
                    PutString(sX + 41, sY + 145, cTemp, Color(45, 25, 25));
                    strcpy(cTemp, DRAW_DIALOGBOX_SHOP10);
                    
                    PutString(sX + 30, sY + 175, cTemp, Color(45, 25, 25));
                    PutString(sX + 31, sY + 175, cTemp, Color(45, 25, 25));
                ...
                case DEF_EQUIPPOS_LHAND:
                    ...
                    PutString(sX + 90, sY + 145, cTemp, Color(45, 25, 25));
                    PutString(sX + 91, sY + 145, cTemp, Color(45, 25, 25));
                ...
                case DEF_EQUIPPOS_PANTS:
                    ...
                    switch (m_pItemForSaleList[m_stDialogBoxInfo[11].cMode - 1]->m_sItemEffectValue4)
                    {
                        case 10:
                            ...
                            {
                                PutString(sX + 95 + 30 - 35, sY + 125 + 45 - 10, cTemp, Color(45, 25, 25));
                                PutString(sX + 96 + 30 - 35, sY + 125 + 45 - 10, cTemp, Color(45, 25, 25));
                                bFlag = TRUE;
                            }
                            else
                            {
                                PutString(sX + 95 + 30 - 35, sY + 125 + 45 - 10, cTemp, Color(55, 25, 25));
                                PutString(sX + 96 + 30 - 35, sY + 125 + 45 - 10, cTemp, Color(55, 25, 25));
                            }
                            break;
                        case 11:
            ...
            if (m_pItemForSaleList[m_stDialogBoxInfo[11].cMode - 1]->m_sLevelLimit != 0)
            {
                ...
                PutString(sX + 75 - 35, sY + 170 + 30 - 10, cTemp, Color(45, 25, 25));
                PutString(sX + 76 - 35, sY + 170 + 30 - 10, cTemp, Color(45, 25, 25));

                format_to_local(cTemp, DRAW_DIALOGBOX_SHOP25, m_pItemForSaleList[m_stDialogBoxInfo[11].cMode - 1]->m_sLevelLimit);
                
                PutString(sX + 145 + 30 - 35, sY + 170 + 30 - 10, cTemp, Color(45, 25, 25));
            ...
            PutString(sX + 127 - 35, sY + 237 - 10, DRAW_DIALOGBOX_SHOP27, Color(40, 10, 10));
            PutString(sX + 128 - 35, sY + 237 - 10, DRAW_DIALOGBOX_SHOP27, Color(40, 10, 10));
            if (iGetTopDialogBoxIndex() == 11 && msZ != 0)
            {
            ...
            for (i = 0; i < 17; i++)
                if ((i < DEF_MAXSKILLTYPE) && (m_pSkillCfgList[i + m_stDialogBoxInfo[15].sView] != NULL))
                {
                    ...
                    if (m_iDownSkillIndex == (i + m_stDialogBoxInfo[15].sView))
                        m_pSprite[DEF_SPRID_INTERFACE_ADDINTERFACE]->PutTransSpriteColor(sX + 215, sY + 47 + i * 15, 21, 50, 50, 50, m_dwTime);
    ...
    switch (m_stDialogBoxInfo[26].cMode)
    {
        case 1:
            ...
            if ((msX >= sX + iAdjX + 60) && (msX <= sX + iAdjX + 153) && (msY >= sY + iAdjY + 175) && (msY <= sY + iAdjY + 195))
                ...
                PutString(sX + iAdjX + 60, sY + iAdjY + 175, "²{¦b´N¸Õ¸Õ¡T", Color(78, 64, 249));
            else PutString(sX + iAdjX + 60, sY + iAdjY + 175, "²{¦b´N¸Õ¸Õ¡T", Color(26, 11, 216));
#else
        ...
        case 3:
            ...
            else m_pSprite[DEF_SPRID_INTERFACE_ND_GAME2]->PutTransSpriteColor(sX + iAdjX + 225, sY + iAdjY + 210, 23, 5, 5, 5, dwTime);
            ...
            else m_pSprite[DEF_SPRID_INTERFACE_ND_GAME2]->PutTransSpriteColor(sX + iAdjX + 225, sY + iAdjY + 230, 24, 5, 5, 5, dwTime);
            ...
            PutAlignedString(sX, sX + m_stDialogBoxInfo[26].sSizeX, sY + 265, DRAW_DIALOGBOX_SKILLDLG2, 55, 25, 25);
            PutAlignedString(sX, sX + m_stDialogBoxInfo[26].sSizeX, sY + 280, DRAW_DIALOGBOX_SKILLDLG3, 55, 25, 25);
            PutAlignedString(sX, sX + m_stDialogBoxInfo[26].sSizeX, sY + 295, DRAW_DIALOGBOX_SKILLDLG4, 55, 25, 25);
            PutAlignedString(sX, sX + m_stDialogBoxInfo[26].sSizeX, sY + 310, DRAW_DIALOGBOX_SKILLDLG5, 55, 25, 25);
            PutAlignedString(sX, sX + m_stDialogBoxInfo[26].sSizeX, sY + 340, DRAW_DIALOGBOX_SKILLDLG6, 55, 25, 25);
            break;
        ...
        case 4:
            ...
            PutString(sX + iAdjX + 44 + 10 + 60, sY + iAdjY + 55 + 3 * 15 + 5, DRAW_DIALOGBOX_SKILLDLG8, Color(45, 25, 25));
        ...
        case 5:
            ...
            PutString(sX + iAdjX + 33, sY + iAdjY + 230 + 75, DRAW_DIALOGBOX_SKILLDLG29, Color(55, 25, 25));
            PutString(sX + iAdjX + 33, sY + iAdjY + 245 + 75, DRAW_DIALOGBOX_SKILLDLG30, Color(55, 25, 25));
        ...
        case 6:
            ...
            if (m_stDialogBoxInfo[26].cStr[2] == 1)
            {
                ...
                PutString(sX + iAdjX + 33 + 11, sY + iAdjY + 200 - 45, DRAW_DIALOGBOX_SKILLDLG31, Color(55, 25, 25));
            ...
            else
            {
                ...
                PutString(sX + iAdjX + 33 + 11, sY + iAdjY + 200, DRAW_DIALOGBOX_SKILLDLG34, Color(55, 25, 25));
            }
...
void CGame::DrawDialogBox_SysMenu(short msX, short msY, char cLB)
{
    ...
    if (m_bIsDialogEnabled[9]) PutString(sX + 208, sY + 180, DRAW_DIALOGBOX_SYSMENU_ON, Color(255, 255, 255));
    else PutString(sX + 207, sY + 180, DRAW_DIALOGBOX_SYSMENU_OFF, Color(200, 200, 200));
    ...
    PutString(sX + 23, sY + 46, MSG_WORLDNAME1, Color(45, 25, 25));
    PutString(sX + 24, sY + 46, MSG_WORLDNAME1, Color(45, 25, 25));
            ...
            if (m_bCitizen == TRUE)
            {
                if (m_bAresden)
                {
                    ...
                    if (m_iGuildRank == 0)
                    {
                        ...
                        else PutAlignedString(sX + 24, sX + 246, sY + 150, DRAWDIALOGBOX_CRUSADEJOB5, 4, 0, 50);
                    }
                    else
                    {
                        ...
                        else PutAlignedString(sX + 24, sX + 246, sY + 150, DRAWDIALOGBOX_CRUSADEJOB7, 4, 0, 50);
                        ...
                        if (m_iGuildRank != -1)
                        {
                            ...
                            else PutAlignedString(sX + 24, sX + 246, sY + 175, DRAWDIALOGBOX_CRUSADEJOB9, 4, 0, 50);
                        }
                    }
                }
                else if (m_bAresden == FALSE)
...
void CGame::DrawDialogBox_Commander(int msX, int msY)
{
    ...
    switch (m_stDialogBoxInfo[36].cMode)
    {
        case 0: 
            ...
            m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20, sY + 322, 3, dwTime); 
            m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20 + 50, sY + 322, 1, dwTime); 
            m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20 + 100, sY + 322, 2, dwTime); 
            m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20 + 150, sY + 322, 30, dwTime); 
            m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20 + 150 + 74, sY + 322, 4, dwTime); 
            PutAlignedString(sX, sX + szX, sY + 40, DRAW_DIALOGBOX_COMMANDER1);

            if ((msX >= sX + 20) && (msX <= sX + 20 + 46) && (msY >= sY + 322) && (msY <= sY + 322 + 52))
            {
                
                m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20, sY + 322, 17, dwTime); 
            ...
            else if ((msX >= sX + 20 + 50) && (msX <= sX + 20 + 46 + 50) && (msY >= sY + 322) && (msY <= sY + 322 + 52))
            {
                ...
                m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20 + 50, sY + 322, 15, dwTime); 
            ...
            else if ((msX >= sX + 20 + 100) && (msX <= sX + 20 + 46 + 100) && (msY >= sY + 322) && (msY <= sY + 322 + 52))
            {
                ...
                m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20 + 100, sY + 322, 16, dwTime); 
            ...
            else if ((msX >= sX + 20 + 150) && (msX <= sX + 20 + 46 + 150) && (msY >= sY + 322) && (msY <= sY + 322 + 52))
            {
                ...
                m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20 + 150, sY + 322, 24, dwTime); 
        ...
        case 1: 
            m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20 + 100 + 74, sY + 322, 20, dwTime); 
            m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20 + 150 + 74, sY + 322, 4, dwTime); 
...
void CGame::DrawDialogBox_Constructor(int msX, int msY)
{
    ...
    switch (m_stDialogBoxInfo[37].cMode)
    {
        case 0: 
            ...
            if ((msX >= sX + 20) && (msX <= sX + 20 + 46) && (msY >= sY + 322) && (msY <= sY + 322 + 52))
            {
                m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20, sY + 322, 24, dwTime); 
            }
            else m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20, sY + 322, 30, dwTime); 

            if ((msX >= sX + 20 + 50) && (msX <= sX + 20 + 46 + 50) && (msY >= sY + 322) && (msY <= sY + 322 + 52))
            {
                m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20 + 50, sY + 322, 15, dwTime); 
            }
            else m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20 + 50, sY + 322, 1, dwTime); 
...
void CGame::DrawDialogBox_Soldier(int msX, int msY)
{
    ...
    switch (m_stDialogBoxInfo[38].cMode)
    {
        case 0: 
            ...
            if ((msX >= sX + 20) && (msX <= sX + 20 + 46) && (msY >= sY + 322) && (msY <= sY + 322 + 52))
            {
                m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20, sY + 322, 15, dwTime); 
            }
            else m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20, sY + 322, 1, dwTime); 
        ...
        case 1: 
            ...
            if ((msX >= sX + 20 + 150 + 74 - 50) && (msX <= sX + 20 + 46 + 150 + 74 - 50) && (msY >= sY + 322) && (msY <= sY + 322 + 52))
            {
                m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20 + 150 + 74 - 50, sY + 322, 19, dwTime); 
            }
            else m_pSprite[DEF_SPRID_INTERFACE_ND_CRUSADE]->PutSpriteFast(sX + 20 + 150 + 74 - 50, sY + 322, 20, dwTime); 
...
void CGame::DrawDialogBox_Help(int msX, int msY)
{
    ...
    else PutAlignedString(sX, sX + szX, sY + 50 + 15 * 14, DRAW_DIALOGBOX_HELP14, 4, 0, 50);
    ...
    else PutAlignedString(sX, sX + szX, sY + 50 + 15 * 15, DRAW_DIALOGBOX_HELP15, 4, 0, 50);
#endif
...
void CGame::DrawDialogBox_ItemUpgrade(int msX, int msY)
{
    ...
    switch (m_stDialogBoxInfo[34].cMode)
    {
        case 1:
            ...
            PutAlignedString(sX + 24, sX + 248, sY + 20 + 30, DRAW_DIALOGBOX_ITEMUPGRADE1);
            PutAlignedString(sX + 24, sX + 248, sY + 20 + 45, DRAW_DIALOGBOX_ITEMUPGRADE2);
            PutAlignedString(sX + 24, sX + 248, sY + 20 + 60, DRAW_DIALOGBOX_ITEMUPGRADE3);
            ...
            if (m_stDialogBoxInfo[34].sV1 != -1)
            {
                ...
                if ((m_pItemList[m_stDialogBoxInfo[34].sV1]->m_cEquipPos == DEF_EQUIPPOS_LHAND) || (m_pItemList[m_stDialogBoxInfo[34].sV1]->m_cEquipPos == DEF_EQUIPPOS_RHAND) || (m_pItemList[m_stDialogBoxInfo[34].sV1]->m_cEquipPos == DEF_EQUIPPOS_TWOHAND))
                {
                    ...
                    m_pSprite[DEF_SPRID_ITEMPACK_PIVOTPOINT + m_pItemList[m_stDialogBoxInfo[34].sV1]->m_sSprite]->PutSpriteColor(sX + 134, sY + 182, m_pItemList[m_stDialogBoxInfo[34].sV1]->m_sSpriteFrame, m_wWR[cItemColor] - m_wR[0], m_wWG[cItemColor] - m_wG[0], m_wWB[cItemColor] - m_wB[0], dwTime);
                }
                else
                {
                    m_pSprite[DEF_SPRID_ITEMPACK_PIVOTPOINT + m_pItemList[m_stDialogBoxInfo[34].sV1]->m_sSprite]->PutSpriteColor(sX + 134, sY + 182, m_pItemList[m_stDialogBoxInfo[34].sV1]->m_sSpriteFrame, m_wR[cItemColor] - m_wR[0], m_wG[cItemColor] - m_wG[0], m_wB[cItemColor] - m_wB[0], dwTime);
                }
                ZeroMemory(cStr1, sizeof(cStr1));
                ZeroMemory(cStr2, sizeof(cStr2));
                ZeroMemory(cStr3, sizeof(cStr3));
        ...
        case 2:
            ...
            if (m_stDialogBoxInfo[34].sV1 != -1)
            {
                ...
                if ((m_pItemList[m_stDialogBoxInfo[34].sV1]->m_cEquipPos == DEF_EQUIPPOS_LHAND) || (m_pItemList[m_stDialogBoxInfo[34].sV1]->m_cEquipPos == DEF_EQUIPPOS_RHAND) || (m_pItemList[m_stDialogBoxInfo[34].sV1]->m_cEquipPos == DEF_EQUIPPOS_TWOHAND))
                {
                    ...
                    m_pSprite[DEF_SPRID_ITEMPACK_PIVOTPOINT + m_pItemList[m_stDialogBoxInfo[34].sV1]->m_sSprite]->PutSpriteColor(sX + 134, sY + 182, m_pItemList[m_stDialogBoxInfo[34].sV1]->m_sSpriteFrame,
        ...
        case 4:
            ...
            PutAlignedString(sX + 24, sX + 248, sY + 55 + 30 + 282 - 117 - 170, DRAW_DIALOGBOX_ITEMUPGRADE9);
        ...
        case 5: 
            PutAlignedString(sX + 24, sX + 248, sY + 20 + 45, DRAW_DIALOGBOX_ITEMUPGRADE13);
        ...
        case 6:
            ...
            DrawNewDialogBox(DEF_SPRID_INTERFACE_ND_GAME3, sX, sY, 3);
            PutAlignedString(sX + 24, sX + 248, sY + 20 + 30, DRAW_DIALOGBOX_ITEMUPGRADE31);
        ...
        case 7: 
            PutAlignedString(sX + 24, sX + 248, sY + 20 + 130, DRAW_DIALOGBOX_ITEMUPGRADE36);
            PutAlignedString(sX + 24, sX + 248, sY + 20 + 145, DRAW_DIALOGBOX_ITEMUPGRADE37);
            // OK
            if ((msX >= sX + DEF_RBTNPOSX) && (msX <= sX + DEF_RBTNPOSX + DEF_BTNSZX) && (msY > sY + DEF_BTNPOSY) && (msY < sY + DEF_BTNPOSY + DEF_BTNSZY))
                DrawNewDialogBox(DEF_SPRID_INTERFACE_ND_BUTTON, sX + DEF_RBTNPOSX, sY + DEF_BTNPOSY, 1);
            else DrawNewDialogBox(DEF_SPRID_INTERFACE_ND_BUTTON, sX + DEF_RBTNPOSX, sY + DEF_BTNPOSY, 0);
        ...
        case 8: 
            PutAlignedString(sX + 24, sX + 248, sY + 20 + 130, DRAW_DIALOGBOX_ITEMUPGRADE38);
        ...
        case 9: 
            PutAlignedString(sX + 24, sX + 248, sY + 20 + 130, DRAW_DIALOGBOX_ITEMUPGRADE39);
        ...
        case 10: 
            PutAlignedString(sX + 24, sX + 248, sY + 20 + 130, DRAW_DIALOGBOX_ITEMUPGRADE40);
