...
BOOL __fastcall CMapData::bSetOwner(WORD wObjectID, int sX, int sY, int sType, int cDir, short sAppr1, short sAppr2, short sAppr3, short sAppr4, int iApprColor, int sStatus, char * pName, short sAction, short sV1, short sV2, short sV3, int iPreLoc, int iFrame)
{
 int   iX, iY, dX, dY; 
 int   iChatIndex, iAdd;
 char  cTmpName[12];
...
int CMapData::iObjectFrameCounter(char * cPlayerName, short sViewPointX, short sViewPointY)
{
    ...
    static DWORD S_dwUpdateTime = unixtime();
	...
	for (dY = 0; dY < MAPDATASIZEY; dY++) {
		...
		if (m_pData[dX][dY].m_sOwnerType != NULL && m_pData[dX][dY].m_sOwnerType > 0 && m_pData[dX][dY].m_sOwnerType < 300) {
			//
...
BOOL __fastcall CMapData::bSetDeadOwner(WORD wObjectID, short sX, short sY, short sType, char cDir, short sAppr1, short sAppr2, short sAppr3, short sAppr4, int iApprColor, int sStatus, char * pName)
{
 int  dX, dY;
 char pTmpName[12];
